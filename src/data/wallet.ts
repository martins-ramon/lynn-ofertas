...
export const journey = [
  { title: 'Tudo começa com a Start.', short: 'Contratação', day: 'Dia 01', text: 'O cliente contrata a oferta T-Coins por meio da assinatura Start, com acesso e franquia inicial. Os produtos de IA entregam as capacidades que motivam essa contratação.', insight: 'Neste exemplo: 100 T-Coins na carteira. Os dois Agentes Padrão utilizados são produtos, não ofertas vendidas separadamente.', focus: 'credit' },
  { title: 'Ativar é diferente de consumir.', short: 'Ativação', day: 'Dia 02', text: 'O cliente ativa dois Agentes Padrão: Documentos do Fluig e Liberação de crédito do Protheus. Habilitar os produtos, sozinho, não gera débito nesta demonstração.', insight: 'OES tem ofertas com contratação própria. Garden tem modelo a definir. Nenhum deles participa desta simulação de consumo.', focus: 'activation' },
